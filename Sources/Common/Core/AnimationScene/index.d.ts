...
/**
 * A scene is itself a cue, so it inherits the start and end times, current
 * time, and tick event, and one scene can be held by another scene. Its public
 * state methods report scene playback state.
 */
