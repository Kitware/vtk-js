 ...
 * @param boundingBox 
 */
export declare function canvasToImageData(canvas : any, boundingBox : number[]): void;
 ...
 * @param transform 
 */
export declare function imageToImageData(image : any, transform : ITransform): void;
