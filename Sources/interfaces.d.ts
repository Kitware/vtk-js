...
export interface vtkOutputPort<T = unknown> {
  (): T;
  filter: vtkAlgorithm;
}
...
export interface vtkAlgorithm {
   ...
   * @param {Number} [port] The port number (default 0).
   */
  getInputConnection(port?: number): Nullable<vtkPipelineConnection>;
...
export interface vtkObject {
   ...
   */
  modified(otherMTime?: number): void;
   ...
   */
  onModified(
    callback: (instance: vtkObject) => void
  ): Nullable<Readonly<vtkSubscription>>;
