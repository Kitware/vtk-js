...
import actorJSON from './clippedDiskOutActor.json';
...
global.render = renWin.render;

global.ok = () => {
  mapper.set({ colorMode: 1, scalarMode: 5, colorByArrayName: '' });
  renWin.render();
};

global.ko = () => {
  mapper.set({ colorMode: 0, scalarMode: 3, colorByArrayName: '__CustomRGBColorArray__' });
  renWin.render();
};
